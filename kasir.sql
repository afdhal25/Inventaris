...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 11 Feb 2025 pada 08.33
...
(1, 'afdhal', 0, 'Petugas'),
(2, 'satya', 0, 'Petugas'),
(3, 'faiz', 123456, 'Petugas'),
(4, 'haikal', 123456, 'Petugas');
...
ALTER TABLE `detailpenjualan`
  ...
  ADD CONSTRAINT `detailpenjualan_ibfk_3` FOREIGN KEY (`UserID`) REFERENCES `user` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Ketidakleluasaan untuk tabel `pelanggan`
--
ALTER TABLE `pelanggan`
  ADD CONSTRAINT `pelanggan_ibfk_1` FOREIGN KEY (`PelangganID`) REFERENCES `penjualan` (`PenjualanID`);
