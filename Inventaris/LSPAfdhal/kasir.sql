...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 11, 2025 at 03:54 AM
...
ALTER TABLE `detailpenjualan`
  ...
  ADD CONSTRAINT `detailpenjualan_ibfk_3` FOREIGN KEY (`UserID`) REFERENCES `user` (`UserID`) ON DELETE CASCADE ON UPDATE CASCADE;
